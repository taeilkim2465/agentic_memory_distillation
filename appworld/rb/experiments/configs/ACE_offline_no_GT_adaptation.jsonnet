...

{
    ...
    "config": {
        ...
        "agent": {
            ...
            "reflector_success_prompt_file_path": experiment_prompts_path + "/appworld_react_reflector_success_prompt.txt",
            "reasoning_bank_file_path": experiment_reasoning_bank_path + "/offline_no_gt_bank.json",
