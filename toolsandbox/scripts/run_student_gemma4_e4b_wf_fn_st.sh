...
VLLM_URL="http://localhost:8991/v1"
...
echo "[Gemma4E4B_WF_FN_ST] VLLM_URL=$VLLM_URL  MEMORY_DIR=$MEMORY_DIR"

/c2/taeil/anaconda3/envs/ToolSandbox/bin/tool_sandbox \
  --agent MemoryGemma4E4B_WF_FN_ST \
  --user GPT_5_Mini \
  --vllm-url "$VLLM_URL" \
